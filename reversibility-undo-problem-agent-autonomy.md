...
- [Capability Is Becoming a Privilege](./capability-is-becoming-a-privilege-earned-agent-access.md) — reversibility is one ceiling on autonomy; earned trust is the other, and the lower of the two applies
